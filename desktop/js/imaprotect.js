...
function getInstruction() {
  	...
  	instruction += "</br>";
  	instruction += "<span>&nbsp;&nbsp;&nbsp;&nbsp;- Assurez-vous que vous avez bien accès à <a href=https://www.imaprotect.com/>IMA Protect</a> rubrique espace client</span>";
  	instruction += "</br>";
...
function buildContactList(id,pkContact) {
    $.ajax({// fonction permettant de faire de l'ajax
        ...
        url: "plugins/imaprotect/core/ajax/imaprotect.ajax.php", // url du fichier php
        data: {
